...
\section{Order attribution, all subsets}\label{app:orderattr}
Each subset's operator is a row block of the frozen full-stack operator: every
order's whitening uses only its own quadrature, so no subset is recalibrated
and all share one noise level, one $72/152$ split and one source Gram. The
nuisance projector is rebuilt for each subset, because the direct order
constrains nuisance coefficients even though its target columns vanish.
Principal angles are measured against the full-stack two-dimensional
operational subspace.

\begin{table}[htbp]
\centering\small
\caption{All seven order subsets at the reference geometry, $\rho=1$, rank
tolerance $10^{-12}$.}
\label{tab:orderattr:full}
\begin{tabular}{l r r r c r r l}
\toprule
Orders&$s_1$&$s_2$&$s_3$&Ops&$\tr F_{\rm cond}$&Nuis.\ rank&Angles\\
\midrule
$0$&0&0&0&0&0.000000&140&---\\
$1$&1.3947&1.2706&0.7491&2&6.073790&120&$2.44^\circ$, $1.63^\circ$\\
$2$&0.2257&0.2210&0.1971&0&0.417208&96&---\\
$0,1$&1.4098&1.2954&0.7606&2&6.276810&148&$3.21^\circ$, $1.36^\circ$\\
$0,2$&0.2356&0.2262&0.2103&0&0.454620&152&---\\
$1,2$&1.4166&1.3210&0.7926&2&6.983964&124&$1.91^\circ$, $0.45^\circ$\\
...
\begin{table}[htbp]
\centering\small
\caption{Order-block energy fractions of the full-stack conditional modes,
$f_{j,n}=\norm{P_n\mathcal B_{\rm cond}v_j}_2^2/s_j^2$, summing to one across
orders. Order 2's share rises in the directions that fail the threshold.}
\label{tab:orderenergy}
\begin{tabular}{c r r r r}
\toprule
Mode&Singular value&$n=0$&$n=1$&$n=2$\\
\midrule
...
The rebuild used for this decomposition reproduces every archived
reference-geometry endpoint before any subset is reported: the three singular
values to $10^{-6}$, both Fisher traces, both operational counts and both
nuisance ranks.
